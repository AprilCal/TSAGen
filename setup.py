...
setup(name="generator", version="1.0", description="some generators", author="Chengyu", py_modules=['generator.additive_anomal_generator','generator.pattern','generator.abstract_generator','generator.noise_generator','generator.trend_generator','generator.season_generator','generator.anomaly_generator'])
